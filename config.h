const char* ssid = "Emer";        //Indicamos el nombre de la red WiFi (SSID) a la que queremos conectarnos.
...
const char* password = "yyyy";  //Indicamos la contraseña de de red WiFi
*/
